export default function Award(props) {
  return (
    <div className="flex flex-row items-center justify-start w-full hover:bg-white hover:bg-opacity-5 border-[1px] border-white border-opacity-10 rounded transition duration-300">
      <div className="flex flex-col items-start justify-center h-28 w-[250px] pl-5 border-[1px] border-white border-opacity-10">
      ...
      <div className="flex flex-col items-start justify-center h-28 w-full pl-5 border-[1px] border-white border-opacity-5">
