...
export default function Technology(props) {
  return (
    <motion.div
      className="flex flex-row items-center justify-start w-full max-h-[8rem] rounded-xl overflow-hidden hover:bg-white hover:bg-opacity-[0.03] border-[1px] border-white border-opacity-5 transition duration-300"
    ...
    >
      ...
      <div className="flex flex-row items-center justify-start w-full min-h-[8rem]">
        <div className="flex flex-col items-start justify-center h-32 w-[175px] p-5 border-[1px] border-white border-opacity-5">
        ...
        <div className="flex flex-col items-start justify-center h-32 w-full p-5 border-[1px] border-white border-opacity-5">
