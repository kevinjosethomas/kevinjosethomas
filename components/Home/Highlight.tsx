...
const Highlight = ({ children, icon, href, rotate = 0 }: HighlightProps) => {
  ...
  const content = (
    <span className="relative inline-flex items-baseline gap-1.5 [box-decoration-break:clone] px-0.5 py-0.5 font-normal whitespace-nowrap text-white decoration-white decoration-1 underline-offset-4 transition-all duration-300 [-webkit-box-decoration-break:clone] hover:bg-white/2 hover:underline focus-visible:bg-white/2 focus-visible:underline">
      {icon && (
        <Image
          src={icon}
          alt=""
